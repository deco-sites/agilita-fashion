  ...
  return (
    <>
      ...
      <div
        ...
        class="md:hidden  flex flex-row justify-center items-center border-b border-base-200 w-full pl-2 pr-6 gap-2"
      >
      ...
      <div class="hidden text-white md:flex flex-col  pb-[20px] items-center w-full pt-[10px] pl-2 pr-6  transition-opacity opacity-100 md:group-hover/item:hidden md:group-hover/item:opacity-0 " >
      ...
      <div class="hidden text-black md:group-hover/item:flex flex-col pb-[20px]  items-center border-b border-base-200 w-full pt-[10px] pl-2 pr-6 transition-opacity opacity-0 md:group-hover/item:opacity-100 md:group-hover/item:bg-white" >
        <div class="md:flex flex-row justify-between  items-center  w-full px-[100px]">
          <div class="flex items-center justify-end gap-[35px]">
            <a
              class=""
